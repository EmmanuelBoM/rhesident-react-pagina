...
function AdminProyectos() {
    ...
    const q = query(proyectosCollectionRef, orderBy("nombre"), where("nombre", "!=", "No eliminar"))
      ...
      [
        ...
        { field: 'ejesAccion', headerName: 'Ejes de acción', flex:1, minWidth: 100},
        {
            ...
            getActions: (params) => [
                ...
                <Link className='link-decoration' to={`/proyecto/${params.id}`} target="_blank"><GridActionsCellItem icon={ <i class="fa-solid fa-up-right-from-square icono-accion-tabla icono-tabla-ir"></i> }  label="Ir a" /></Link>,
        ...
        <main className="main-admin">
          <header className="header-panel">
            <div className="cont-bienvenida">
              <svg
                className="icono-pagina icono-proyectos"
                viewBox="0 0 28 30"
                fill="none"
