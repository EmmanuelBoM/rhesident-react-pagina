...
function AdminBeneficiarios() {
    ...
    const q = query(beneficiariosCollectionRef, orderBy("nombre"), where("nombre", "!=", "No eliminar"))
    ...
    <div className="body-admin">
      ...
      {modalVisibility ? (
        <ModalAdminEliminar
          ...
          recurso="el beneficiario"
          nombreRecurso={modalInfo}
          runFunction={deleteBeneficiario}
        ></ModalAdminEliminar>
      ) : null}
