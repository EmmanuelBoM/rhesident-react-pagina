...
function AdminAgregarTestimonio() {
    ...
    const [imgURL, setImgPerfilURL] = useState('')
    ...
    const handleImgPerfilChange = async (e) =>{
        ...
        const bucketPath =`images/equipo/${testimonio.nombre}_imgPerfil`
    ...
    const handleImgCompletaChange = async (e) =>{
        ...
        const file = e.target.files[0]
        const bucketPath =`images/equipo/${testimonio.nombre}_imgCompleta`
    ...
    const testimoniosCollectionRef = collection(db, "equipo")
            ...
            await addDoc(testimoniosCollectionRef,
                {
                    ...
                    areaEspecializacion: testimonio.areaEspecializacion,
    ...
    return (
        <div className="body-admin">
            {modalExitoVisibility ? <ModalAdminExito setModalVisibility={setModalExitoVisibility} rutaContinuar='/admin_equipo' accion='agregado' recurso= 'Testimonio' nombreRecurso={testimonio.nombre}></ModalAdminExito> : null }
                    ...
                    <div className="cont-formulario-agregar">
                        <form action="" className="formulario-registro">
                            ...
                            <div className="file-preview">
                                <input type="file" name="imgURL" id="" className="input-archivo" onChange={handleImgPerfilChange}/>
