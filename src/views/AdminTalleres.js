...
function AdminTalleres() {
      ...
      [
        ...
        { field: 'duracion', headerName: 'Duración (Hrs.)', flex:1, minWidth: 20},
        {
            ...
            getActions: (params) => [
                ...
                <Link className='link-decoration' to={`/taller/${params.id}`}><GridActionsCellItem icon={ <i class="fa-solid fa-up-right-from-square icono-accion-tabla icono-tabla-ir"></i> }  label="Ir a" /></Link>,
    ...
    return (
        <div className="body-admin">
            ...
            {modalVisibility ? <ModalAdminEliminar setModalVisibility={setModalVisibility} recurso='el taller' nombreRecurso={modalInfo} runFunction={deleteTaller}></ModalAdminEliminar> : null}
                    ...
                    <section className="panel-bottom">
                        <div className="layout1-panel-top">
                            ...
                            <Link  to='/agregar-taller' className="btn-agregar-panel">
                                ...
                                <img src={iconoAgregarTaller} alt="" className='icono-agregar'/>
                            </Link>
                        ...
                        <div className="card-contenido-panel card-cont-tabla">
                            ...
                            <DataGrid autoHeight rows={talleres} columns={columns} sx={datagridStyles} localeText={esES.components.MuiDataGrid.defaultProps.localeText}/>
                        </div>
                    </section>
            </main>
        </div>
