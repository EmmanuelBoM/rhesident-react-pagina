  ...
  window.addEventListener('scroll', autoPlayVideo)
    ...
    return (
        ...
        <section className="conoce">
            ...
            <AnimationOnScroll animateIn="animate__fadeInLeft" animateOut='animate__fadeOutLeft' offset={190}>
              <div className="nodes-cont-l" onClick={() => window.location.replace("/nuestras-intenciones#objetivo")}>
            ...
            <AnimationOnScroll animateIn="animate__fadeInRight" animateOut='animate__fadeOutRight' offset={200}>
              <div className="nodes-cont-r" onClick={() => window.location.replace("/nuestras-intenciones#objetivo")}>
                <div className="node-conoce"></div>
            ...
            <svg className='line-conoce-2' viewBox="0 0 10 524" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line x1="5" x2="5" y2="550" stroke="#F0E967" stroke-width="10"/>
            </svg>
            <AnimationOnScroll animateIn="animate__fadeInLeft" animateOut='animate__fadeOutLeft' offset={200}>
              <div className="nodes-cont-l"  onClick={() => window.location.replace("/nuestro-origen#filosofia")}>
                <p className="node-texto">Nuestra <br /> filosofía</p>
                <div className="node-conoce"></div>
              </div>
            </AnimationOnScroll>
            <AnimationOnScroll animateIn="animate__fadeInRight" animateOut='animate__fadeOutRight' offset={180}>
              <div className="nodes-cont-r" onClick={() => window.location.replace("/nuestro-origen#historia")}>
                <div className="node-conoce"></div>
                <p className="node-texto">Nuestra <br /> marca</p>
              </div>
            </AnimationOnScroll>
            <AnimationOnScroll animateIn="animate__fadeInLeft" animateOut='animate__fadeOutLeft' offset={200}>
              <div className="nodes-cont-l" onClick={() => window.location.replace("/nuestro-origen#marca")}>
                <p className="node-texto">Nuestra <br /> historia</p>
                <div className="node-conoce"></div>
              </div>
            </AnimationOnScroll>
            <AnimationOnScroll animateIn="animate__fadeIn" duration={3}>
                <div className="item-conoce">
                    ...
                    <h4 className="verde subt-conoce">Nuestros <br /> Procesos <br /> comunitarios</h4>
                    <p className="negro text-conoce">La inmediatez del ahora, suele impedir valorar los procesos. Aquí te presentamos los nuestros.</p>
                    <Link className="corazon-conoce" to='/nuestro-origen'>
                        <img src={iconoProcesos} alt="" />
                    </Link>
                </div>
            </AnimationOnScroll>
            <svg className='line-conoce-3' viewBox="0 0 10 524" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line x1="5" x2="5" y2="590" stroke="#F0E967" stroke-width="10"/>
            </svg>
            <AnimationOnScroll animateIn="animate__fadeInRight" animateOut='animate__fadeOutRight' offset={180}>
              <div className="nodes-cont-r" onClick={() => window.location.replace("/proyectos#cultura")}>
                <div className="node-conoce"></div>
            ...
            <AnimationOnScroll animateIn="animate__fadeInLeft" animateOut='animate__fadeOutLeft' offset={190}>
              <div className="nodes-cont-l" onClick={() => window.location.replace("/proyectos#arte")}>
                <p className="node-texto">Arte</p>
                <div className="node-conoce"></div>
              </div>
            </AnimationOnScroll>
            <AnimationOnScroll animateIn="animate__fadeInRight" animateOut='animate__fadeOutRight' offset={200}>
              <div className="nodes-cont-r" onClick={() => window.location.replace("/proyectos#urbanismo")}>
                <div className="node-conoce"></div>
                <p className="node-texto">Urbanismo</p>
              </div>
            </AnimationOnScroll>
            <AnimationOnScroll animateIn="animate__fadeInLeft" animateOut='animate__fadeOutLeft' offset={190}>
              <div className="nodes-cont-l" onClick={() => window.location.replace("/proyectos#sustentabilidad")}>
            ...
            <AnimationOnScroll animateIn="animate__fadeIn" duration={3}>
                <div className="item-conoce">
                    ...
                    <h3 className="verde subt-conoce">Nuestro <br /> Equipo</h3>
                    <p className="negro text-conoce">Conoce a quienes han decidido otorgar sus dones y talentos, al servicio de otras y otros. Éste es nuestro equipo.</p>
