    ...
    <div>
      <div className="modal-bg">
        <div className="cont-modal-miembro">
          <div
            className="imagen-completa-miembro"
            style={stylesImgCompleta}
          ></div>
          <div className="modal-contenido">
            ...
            <h2 className="nombre-miembro-modal verde">
              {props.miembro.nombre}
            </h2>
            <p className="descripcion-miembro-modal negro">
              {props.miembro.descripcion}
            </p>
          </div>
        </div>
      </div>
