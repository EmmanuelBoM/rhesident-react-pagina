  ...
  return (
    <div className="cont-miembro" onClick={showModal}>
      ...
      >
        <defs>
          <pattern
            id={`imgMiembro${props.miembro.id}`}
            className="img-miembro"
          ...
          >
            <image
              className="img-miembro-perfil"
              href={props.miembro.imgPerfilURL}
              width="261"
              height="261"
            />
          </pattern>
        ...
        <path
          ...
          fill={`url(#imgMiembro${props.miembro.id})`}
        />
      </svg>
