    ...
    return (
      <header className="header-principal">
        <div className="cont-logo">
          <Link to="/">
            <img
              src={props.textColor == "blanco" ? logo : logoDark}
              alt=""
        ...
        <nav className="nav-principal">
          <ul className="nav-list">
            <li className="nav-element nav-submenu">
              ...
              <a
                className={
                  props.textColor == "blanco"
                    ? `submenu-title blanco`
                    : `submenu-title negro`
                }
              >
                ¿Quienes somos?
                ...
                className={
                  props.textColor == "blanco"
                    ? `nav-indicator light ${
                        ...
                        location.pathname === "/nuestras-intenciones" ||
                        location.pathname === "/nuestra-huella" ||
                        location.pathname === "/nuestro-origen"
                          ? "active-light"
                          : null
                      }`
                    : `nav-indicator dark`
              ...
              <div
                className={
                  props.textColor == "blanco"
                    ? `nav-indicator light`
                    : `nav-indicator dark ${
                        location.pathname === "/tienda" ? "active-dark" : null
                      }`
                }
              ></div>
            </li>
        ...
        <div className="header-filler">
          ...
          <i
            className="fa-solid fa-bars icono-menu"
            onClick={showMenuMovil}
          ></i>
        </div>
      </header>
    );
